...
public class OnlineMapsTileSetControl : OnlineMapsControlBase3D
{
    ...
    private List<Vector3> markersVerticles;
    ...
    private void UpdateMarkersMesh()
    {
        ...
        if (markersVerticles == null) markersVerticles = new List<Vector3>(64);
        else markersVerticles.Clear(); 
...
#else
        markersMesh.SetVertices(markersVerticles);
#endif
	...
	/// </summary>
	//TZ
	public void CreateMarkerInPos(Vector3 pos)
	{
		Vector2 aux = GetCoordsByWorldPosition (pos);
		map.AddMarker(aux);
