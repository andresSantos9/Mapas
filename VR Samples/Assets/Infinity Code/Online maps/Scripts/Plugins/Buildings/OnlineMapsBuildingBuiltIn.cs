...
public class OnlineMapsBuildingBuiltIn : OnlineMapsBuildingBase
{
    ...
    private void CreateHouseRoof(List<Vector3> baseVerticles, float baseHeight, float roofHeight, RoofType roofType)
    {
        float[] roofPoints = new float[baseVerticles.Count * 2];

        if (roofVertices == null) roofVertices = new List<Vector3>(baseVerticles.Count);
    ...
    private void CreateHouseWall(List<Vector3> baseVerticles, float baseHeight, Material material, Vector2 materialScale)
    {
        CreateHouseWallMesh(baseVerticles, baseHeight, false);
    ...
    private void CreateHouseWallMesh(List<Vector3> baseVerticles, float baseHeight, bool inverted)
    {
