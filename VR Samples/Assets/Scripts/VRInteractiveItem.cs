...
namespace VRStandardAssets.Utils
{
    ...
    public class VRInteractiveItem : MonoBehaviour
    {
        ...
        public void Over()
        {
			//Debug.LogError ("Over: "+gameObject.name);	
            m_IsOver = true;
			if (OnOver != null)
                OnOver();
        }
        ...
        public void Out()
        {
			Debug.LogError ("Out: "+gameObject.name);			
            m_IsOver = false;
        ...
        public void Click()
        {
			Debug.LogError("click: "+gameObject.name);
            if (OnClick != null)
                OnClick();
        }
        ...
        public void Up()
        {
			Debug.LogError ("Up: "+gameObject.name);				
            if (OnUp != null)
                OnUp();
        }
        ...
        public void Down()
        {
			Debug.LogError ("Down: "+gameObject.name);			
